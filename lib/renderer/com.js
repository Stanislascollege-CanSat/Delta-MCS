...
const com = {
  ...
  openPort: function () {
    com.open(com.chosenDevice.comName, 115200)
  },
  ...
  closeEvent: function () {
    com.port.on('close', () => {
      console.error('%c[COM] %cport closed.', 'color: #38006b', 'color: #000')
      missionConsole.error('[COM] port closed.')
      ...
      // Set status indicators to error.
      data.status.reset()
      data.changeStatus('Serial', 0)
